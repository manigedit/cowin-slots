...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Submitting with ', phoneRef.current.value, ageRef.current.value, pincodeRef.current.value)
  ...
  <input placeholder="Whatsapp Number" type="tel" maxLength="10" ref={phoneRef} ></input>
  <input placeholder="Age" type="tel" maxLength="2" minLength="2" ref={ageRef} ></input>
  <input placeholder="Pincode" type="tel" maxLength="6" ref={pincodeRef} ></input>
  <button onClick={handleSubmit} >Send</button>
</form>

<a href="https://twitter.com/manigedit" target="_blank"><i className="fa fa-twitter"></i>Follow Me</a>
